...
import com.mstring.andtest.bean.LeLiveGetPushUrlBean;
...
public class LeLiveGetPushUrlActivity extends BaseLeLiveNetActivity<LeLiveGetPushUrlBean> {
    ...
    private void startRequest() {
        ...
        String url = LeUrlUtils.getLiveGetPushUrl(activityId);

        VolleyHelper.stringRequestByGet(url, this, this);
    }

    @Override
    protected void parseData(LeLiveGetPushUrlBean data) {
        mTvResult.setText(data.toString());
    }

    @Override
    protected Type getType() {
        return new TypeToken<LeLiveGetPushUrlBean>() {
        }.getType();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_le_live_get_pushurl;
    }
}
