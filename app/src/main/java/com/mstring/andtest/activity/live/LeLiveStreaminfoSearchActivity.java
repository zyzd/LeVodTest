...
import com.mstring.andtest.bean.LeLiveStreaminfoSearchBean;
...
public class LeLiveStreaminfoSearchActivity extends BaseLeLiveNetActivity <LeLiveStreaminfoSearchBean>{
    ...
    private void startRequest() {
        ...
        String url = LeUrlUtils.getLiveStreaminfoSearchUrl(activityId);

        VolleyHelper.stringRequestByGet(url, this, this);
    }

    @Override
    protected void parseData(LeLiveStreaminfoSearchBean data) {
        mTvResult.setText(data.toString());
    }

    @Override
    protected Type getType() {
        return new TypeToken<LeLiveStreaminfoSearchBean>(){}.getType();
    }
