...
import com.mstring.andtest.bean.LeLiveGetPlayInfoBean;
...
public class LeLiveGetPlayInfoActivity extends BaseLeLiveNetActivity<LeLiveGetPlayInfoBean> {
    ...
    private void startRequest() {
        ...
        String url = LeUrlUtils.getLiveGetPlayInfo(activityId);

        VolleyHelper.stringRequestByGet(url, this, this);
    }

    @Override
    protected void parseData(LeLiveGetPlayInfoBean data) {
        mTvResult.setText(data.toString());
    }

    @Override
    protected Type getType() {
        return new TypeToken<LeLiveGetPlayInfoBean>() {
        }.getType();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_le_live_get_play_info;
    }
}
