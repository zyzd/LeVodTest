...
import com.lecloud.skin.ui.utils.GestureControl.GestureControlListener;
...
//		canGesture(canGesture);
    ...
    protected void attachGestureController(View view, boolean cancel) {
        ...
        if (mGestureControl == null) {
            ...
            mGestureControl.setOnGestureControlListener(new GestureControlListener() {
...
//        }
    ...
    @Override
    public void setRePlayListener(IReplayListener l) {
        if(mNoticeView!=null){
